    ...
    <div className="Purva-Container">
      ...
      <div className="event-container">
        {events.map((event, index) => (
          <div className="event-card-cont" key={index}>
          <div
...
>
              ...
              <div className="event-info">
                ...
                <p className="event-desc">{event.topic}</p>
                <div className="event-icons">
                  <span className="icon-text">
                    <img src={Clock} className="info-icon" alt="clock" /> संध्याकाळी ५ वाजता
                  </span>
                  <span className="icon-text">
                    <img src={Loc} className="info-icon" alt="location" /> {event.place}
                  </span>
                </div>
                
                <p className="event-descx">{event.details}</p>
                 <Link to ="/Answer"
                  className="purva-button">
                  वाचा
                </Link>
              </div>
