  ...
  const contentData = [
    {
      ...
      alt: "ई-बुक",
      title: "ई – बुक",
      desc: "कवितांचं गाव प्लॅटफॉर्मवर खास मराठी कवींसाठी curated ई-पुस्तकांचा संग्रह उपलब्ध आहे...",
      link: "/Ebook",
    },
    {
      img: diwali,
      alt: "दिवाळी अंक",
      title: "दिवाळी अंक",
      desc: "प्रत्येक वर्षी प्रकाशित होणारा खास दिवाळी अंक म्हणजे नव्या प्रतिभेला वाव देणारा साहित्यिक उत्सव...",
      link: "/Diwali",
    },
    {
      img: magazine,
      alt: "मासिक",
      title: "मासिक",
      desc: "प्रत्येक महिन्यात प्रकाशित होणारं आमचं खास साहित्यिक मासिक – नवोदित आणि प्रस्थापित कवींना एकत्र आणणारं...",
      link: "/Masik",
    },
  ];
        ...
        {contentData.map((item, index) => (
          ...
          >
            ...
            <div className="aamcha-card">
              ...
              <p className="ebook-desc">{item.desc}</p>
              <div className="ebook-buttons">
                <Link className="read-button" to={item.link}>
                  वाचा
                </Link>
                <button className="download-button">Download</button>
              </div>
