  ...
  <div className='Prawas-Container'>
   ...
   <div className="timeline-container">
      ...
      <div className="event-section">
        <button onClick={handlePrev} disabled={currentIndex === 0} className="arrow-button"><i class="fa-solid fa-caret-left"></i></button>
        <div className="event-content">
        <h2 className="event-date">{currentEvent.date}</h2>
          <h3 className="event-title">{currentEvent.title}</h3>
          <p className="event-description">{currentEvent.description}</p>
        </div>
        <button onClick={handleNext} disabled={currentIndex === years.length - 1} className="arrow-button">  <i class="fa-solid fa-caret-right"></i> </button>
      </div>
