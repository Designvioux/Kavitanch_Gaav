...
import SlideshowModal from './SlideModal'; // ✅
  ...
  return (
    <div className="gallery-container">
      <div className="gallery-image-container">
        ...
        <div className="image-cont1" onClick={() => handleOpenModal([img17, img18])}>
          <img className='img1' src={img17} alt="Gallery1" />
          <div className="right-img-cont">
            <img className='img2' src={img18} alt="gallery2" />
            <img className='img3' src={img19} alt="gallery3" />
            <img className='img4' src={img20} alt="gallery4" />
          </div>
        </div>

        {/* Repeat for other containers */}
        <div className="images-cont2" onClick={() => handleOpenModal([img19, img20])}>
          {/* images */}
        </div>

        <div className="image-cont3" onClick={() => handleOpenModal([img21, img22])}>
          {/* images */}
        </div>

        <div className="image-cont4" onClick={() => handleOpenModal([img23, img24])}>
          {/* images */}
        </div>
