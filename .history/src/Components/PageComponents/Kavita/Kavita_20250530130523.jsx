...
const poems = [
  {
    ...
    author: "-कुसुमाग्रज",
    Image : Img1,
    component: Book, // <-- use component not path
...
const categories = ["प्रेम कविता", "निसर्ग कविता", "बाल कविता", "हास्य कविता", "सामाजिक कविता", "भक्ती कविता"];
    ...
    <div className="Kavita-container">
      ...
      <div className="poem-grid">
        {poems.map((poem, index) => (
          <div key={index} className="poem-link" onClick={() => handlePoemClick(poem)}>
      ...
      {selectedPoem && (
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="modal-author">{selectedPoem.author}</p>
            <img src={selectedPoem.Image} alt={selectedPoem.title} className="modal-img" />
            <p className="modal-text">{selectedPoem.content}</p>
