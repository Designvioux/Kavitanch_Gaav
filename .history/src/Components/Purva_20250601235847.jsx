...
>
              ...
              <div className="Purva-event-date">
                <img src={Calendar} className=".Purva-Calendar-icon" alt="calendar" />
                <p>{event.date}</p>
              </div>
              ...
              <div className="Purva-event-info">
                ...
                <div className="Purva-event-icons">
                  <span className="Purva-icon-text">
                    <img src={Clock} className="Purva-info-icon" alt="clock" /> संध्याकाळी ५ वाजता
                  </span>
                  <span className="Purva-icon-text">
                    <img src={Loc} className="Purva-info-icon" alt="location" /> {event.place}
                  </span>
                </div>
